...
export default function TeamLeaderboardIndex() {
...
<<<<<<<< HEAD:client/src/pages/dashboard/test/leaderboard/team.tsx
    push(
      {
...
>>>>>>>> origin/main:client/src/pages/dashboard/test/leaderboard/ranking.tsx
  };
